...
export const MainGeneral = () => {
  ...
  return (
    <>
    <Box sx={{ margin: 0,padding: 2,bgcolor: 'background.default'}}>
        <TextField 
                id="outlined-basic" 
        ...
        {resultados.length>articulosPorPagina &&<Pagination count={parseInt(conteoArticulos)} defaultPage={1} page={inicioArticulo} onChange={handlePagination} size='large'/>}
    </Box>
    </> 
  )
}
